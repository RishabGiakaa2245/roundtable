    ...
    <>
      ...
      >
        ...
        <div className="w-full bg-[url('/images/agenda/img_image1_1.png')] bg-cover bg-center">
          <motion.div 
            className="w-full bg-[url('/images/agenda/Vector_80.png')] bg-cover bg-center"
              ...
              <div className="flex flex-row justify-start items-end w-full">
                ...
                >
                  ...
                  >
                    ...
                    <motion.h1 
                      className="text-[24px] sm:text-[36px] md:text-[38px] font-lufga font-normal leading-[31px] sm:leading-[46px] md:leading-[62px] text-left text-[#ffffff] w-full sm:w-[46%] md:w-[100%]"
                      variants={textVariants}
                      whileHover={{
                        scale: 1.02,
                        transition: { duration: 0.3 }
                    ...
                    >
                      ...
                      >
                        Inspiring Voices, Expert Insights
                      </motion.span>
                    </motion.h1>
                    ...
                    >
                      <motion.p 
                        className="text-[8px] w-[100%] sm:w-[50%] sm:text-[12px] md:text-[16px] font-lufga font-normal leading-[10px] sm:leading-[15px] md:leading-[21px] text-left text-[#ffffff] "
                        whileHover={{
                          scale: 1.05,
                          color: "#f0f0f0",
                      ...
                      >
                        Our speakers bring diverse experiences and cutting-edge perspectives from across industries. Get ready to learn, challenge ideas, and spark new opportunities.
                      </motion.p>
