              ...
              <div className="flex flex-row justify-start items-end w-full">
                ...
                >
                  ...
                  >
                    ...
                    <motion.h1 
                      className="text-[24px] sm:text-[36px] md:text-[48px] font-lufga font-normal leading-[31px] sm:leading-[46px] md:leading-[62px] text-left text-[#ffffff] w-full sm:w-[46%] md:w-[80%]"
                      variants={textVariants}
                      whileHover={{
                        scale: 1.02,
                        transition: { duration: 0.3 }
